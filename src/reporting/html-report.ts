...
function summaryCards(s: EvalSummary): string {
  ...
  return [
    ...
    card("P95 latency", `${m.latencyMsP95} ms`, s.measurement.latencyEstimated ? "estimated/demo" : "measured"),
...
<body>
  <div class="wrap">
    ...
    <footer>
      Generated by the Agent Skill Verification Template · model adapter: ${esc(s.model.name)} (${esc(s.model.type)}).
    </footer>
  </div>
</body>
</html>
